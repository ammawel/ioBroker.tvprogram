...
function tvprogramclass(adapter) {
    const api_channels = 'http://tvfueralle.de/api/channels';
    const api_categories = 'http://tvfueralle.de/api/categories';
    const api_genres = 'http://tvfueralle.de/api/genres';
    const api_program = 'http://tvfueralle.de/api/broadcasts/%DATE%';
